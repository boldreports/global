            ...
            case "boldReportViewer":
                ...
                ej.ReportViewer.Locale["ja-JP"] = {
                    toolbar: {
                        ...
                        exportsetup: {
                            headerText: "エクスポート設定",
                            contentText: "イメージの品質、単語の保存の種類、および エクセルドキュメントを設定するには、エクスポートセットアップ オプションを選択します。"
                        },
                    },
                    pagesetupDialog: {
                        close: '閉じる',
                    ...
                    errorMessage: {
                        ...
                        cancelReportProcessMsg: 'レポート処理はキャンセルされました。',
                    },
                    progressMessage: {
                    ...
                    reportItemLabel:{
                        Tablix:'Tablixレポートアイテム',
                        Textbox:'テキストボックスのレポート要素',
                        Chart:'チャートレポートアイテム',
                        Image:'画像レポートアイテム',
                        Custom:'カスタムレポートアイテム',
                        Rectangle:'長方形レポートアイテム',
                        Map:'マップレポートアイテム',
                        Gauge:'ゲージレポートアイテム',
                        Indicator:'指標レポート項目',
                        Line:'指標レポート項目',
                        Subreport:'サブレポートアイテム'
                    },
                    selectAll: 'すべて選択',
                    viewButton: "[レポートの表示",
                    parameterBlock: 'パラメータブロック',
                    parameterProcessingMessage: 'パラメータ値の読み込み...',
                };
                break;
            case "ejRibbon":
